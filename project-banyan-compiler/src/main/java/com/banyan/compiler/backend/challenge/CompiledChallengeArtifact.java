...
public final class CompiledChallengeArtifact extends AbstractCompiledArtifact<CompiledChallenge> {
    ...
    public CompiledChallengeArtifact(String id, int version, CompiledChallenge field, CompilationMetadata metadata,List<ArtifactReference> dependencies) {
        super(id,version, ArtifactType.Challenge,field,metadata,dependencies);
    }
}
